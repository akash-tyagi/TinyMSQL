...
public class Tuple implements Serializable {
	...
	public boolean setField(int offset, String s) {
		...
		if (offset >= schema.getNumOfFields() || offset < 0) {
			System.err.print("setField ERROR: offset " + offset
					+ " is out of bound!" + "\n");
			return false;
		} else if (schema.getFieldType(offset) != FieldType.STR20) {
			System.err.print(
					"setField ERROR: field type not FieldType.STR20!" + "\n");
			return false;
		} else {
	...
	public boolean setField(String field_name, String s) {
		...
		if (!schema.fieldNameExists(field_name)) {
			System.err.print("setField ERROR: field name " + field_name
					+ " not found" + "\n");
			return false;
		}
	...
	public Field getField(int offset) {
		if (offset < fields.size() && offset >= 0) {
			...
			System.err.print("getField ERROR: offset " + offset
					+ " is out of bound!" + "\n");
			return new Field();
		}
	}
