...
public class TestStorageManager {
	...
	private static void appendTupleToRelation(Relation relation_reference,
	...
	public static void main(String[] args) {
		...
		System.out.print(
				"The schema has " + schema.getNumOfFields() + " fields" + "\n");
		System.out.print("The schema allows " + schema.getTuplesPerBlock()
				+ " tuples per block" + "\n");
		...
		System.out.print("\n");
		System.out.print(
				"The first field is of name " + schema.getFieldName(0) + "\n");
		System.out.print("The second field is of type "
				+ (schema.getFieldType(1)) + "\n");
		System.out.print("The field f3 is of type "
				+ (schema.getFieldType("f3")) + "\n");
		System.out.print("The field f4 is at offset "
				+ schema.getFieldOffset("f4") + "\n" + "\n");
		...
		Schema schema_error4 = new Schema(field_names, field_types); // ArrayList
																		// sizes
																		// unmatched
		...
		Relation relation_reference = schema_manager
		...
		// Error testing
		System.out.print("Error testing: " + "\n");
		schema_manager.createRelation(relation_name, schema); // create a
																// relation with
																// the same name
		schema_manager.createRelation("test", new Schema()); // create a
																// relation with
																// empty schema
		System.out.print("\n");
		...
		System.out.print("From the schema manager, the table " + relation_name
				+ " exists: " + (schema_manager.relationExists(relation_name)
						? "TRUE" : "FALSE")
				+ "\n");
		System.out.print("From the schema manager, the table " + relation_name
				+ " has schema:" + "\n");
		...
		System.out.print("From the schema manager, the table " + relation_name
				+ " has schema:" + "\n");
		System.out.print(
				schema_manager.getRelation(relation_name).getSchema() + "\n");

		System.out.print(
				"Creating table ExampleTable2 with the same schema" + "\n");
		schema_manager.createRelation("ExampleTable2", schema);
		System.out
				.print("After creating a realtion, current schemas and relations: "
						+ "\n");
		System.out.print(schema_manager + "\n");
		...
		System.out.print(field_types.toString() + "\n");
		relation_reference = schema_manager.createRelation("ExampleTable3",
				schema3);
		System.out
				.print("After creating a realtion, current schemas and relations: "
						+ "\n");
		...
		System.out
				.print("After deleting a realtion, current schemas and relations: "
						+ "\n");
		System.out.print(schema_manager + "\n" + "\n");
		...
		System.out.print("The table ExampleTable2 exists: "
				+ (schema_manager.relationExists("ExampleTable2") ? "TRUE"
						: "FALSE")
				+ "\n");
		...
		schema_manager.deleteRelation("ExampleTable2"); // relation does not
														// exist
		System.out.print("\n");
		...
		System.out.print("Created a tuple " + tuple
				+ " of ExampleTable3 through the relation" + "\n");
		System.out.print("The tuple is invalid? "
				+ (tuple.isNull() ? "TRUE" : "FALSE") + "\n");
		Schema tuple_schema = tuple.getSchema();
		System.out.print("The tuple has schema" + "\n");
		System.out.print(tuple_schema + "\n");
		System.out.print("A block can allow at most "
				+ tuple.getTuplesPerBlock() + " such tuples" + "\n");
		...
		System.out.print("The block is full? "
				+ (block_reference.isFull() ? "true" : "false") + "\n");
		System.out.print("The block currently has "
				+ block_reference.getNumTuples() + " tuples" + "\n");
		...
		// Error testing
		System.out.print("Error testing: " + "\n");
		Tuple tuple2 = schema_manager.getRelation("ExampleTable1")
				.createTuple();
		...
		appendTupleToRelation(relation_reference, mem, 5, tuple);
		System.out
				.print("*NOTE: The example here does not consider empty tuples (if any) in the block."
						+ "\n");
		...
		System.out
				.print("Read bulk blocks from the relation to memory block 3-9"
						+ "\n");
		...
		System.out
				.print("Write bulk blocks from the memory block 3-9 to the end of the relation"
						+ "\n");
		System.out.print("(May result in 'holes' in the relation)" + "\n");
		relation_reference.setBlocks(relation_reference.getNumOfBlocks(), 3,
				9 - 3 + 1);
		System.out.print("Now the relation contains: " + "\n");
		System.out.print(relation_reference + "\n");
		...
		System.out
				.print("Reading the first block of the relation into memory block 1:"
						+ "\n");
		...
		System.out
				.print("Writing memory block 1 back to the first block of the relation"
						+ "\n");
		...
		System.out
				.print("Reading the last block of the relation into memory block 1:"
						+ "\n");
		...
		System.out
				.print("Writing memory block 1 back to the last block of the relation"
						+ "\n");
		...
		System.out
				.print("Deleting the last block of the relation to remove trailing space"
						+ "\n");
		relation_reference
				.deleteBlocks(relation_reference.getNumOfBlocks() - 1);
		System.out.print("Now the relation contains: " + "\n");
		System.out.print(relation_reference + "\n" + "\n");
		...
		relation_reference.deleteBlocks(relation_reference.getNumOfBlocks()); // out
																				// of
																				// bound
		schema_manager.getRelation("ExampleTable1").setBlock(0, 0); // different
																	// table
																	// schemas
		schema_manager.getRelation("ExampleTable1").setBlocks(0, 0, 1); // different
																		// table
																		// schemas
		System.out.print("\n");
		...
		System.out
				.print("Reading the first block of the relation into memory block 9:"
						+ "\n");
		...
		System.out
				.print("(Can apply sorting and heap building to the tuples later):"
						+ "\n");
		...
		System.out.print("Calculated elapse time = " + disk.getDiskTimer()
				+ " ms" + "\n");
