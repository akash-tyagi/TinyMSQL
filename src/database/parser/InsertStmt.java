...
public class InsertStmt extends StmtBase implements StmtInterface {
    ...
    private void parseTuples(String tuples) {
        ...
        for (String value : list) {
            ...
            valueList.add(value);
            System.out.println("CREATE Statement: value:" + value);
        }
    }
    ...
    public void execute() {
        ...
        Relation relation_reference = dbManager.schema_manager.getRelation(tableName);
        Schema schema = relation_reference.getSchema();
        ArrayList<FieldType> field_types = schema.getFieldTypes();
        // POINT 1 : EVEN THOUGH RELATION RETURNS TUPLE. THIS IS JUST A TUPLE "new Tuple()" 
