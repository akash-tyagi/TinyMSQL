...
public class GeneralUtils {
    ...
    public static void sortMainMemory(DbManager dbManager, ArrayList<String> sortingCols, int memBlocksUsed) {
    ...
    private static void addTuplesToArray(ArrayList<TupleObject> tupleObjectArray, ArrayList<Tuple> blockTuples, ArrayList<String> sortingCols) {
